              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">APLIKASI PENGGAJIAN <br> <b> PELANGI FRAME </b> </h1>
                  </div>
                  ...
                  <form class="user" method="POST" action="<?php base_url('Auth') ?>">
                    ...
                    <button type="submit" href="<?php base_url('auth');?>" class="btn btn-primary btn-user btn-block">
                      Login
                    </button>
                  </form>
                </div>
