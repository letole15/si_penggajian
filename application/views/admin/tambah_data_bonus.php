    <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
      <div class="card-header py-3 bg-primary">
        <h6 class="m-0 font-weight-bold text-white">Input Bonus Karyawan</h6>
      </div>
      <div class="card-body">
            ...
            <tfoot class="text-center">
              <tr>
                ...
                <th width="15%">THR</th>
			     ...
			     <?php $no=1; foreach ($input_bonus as $b) 
           { ?>
	          	<input type="hidden" name="bulan[]" class="form-control" value="<?= $bulantahun ?>">
	          	<input type="hidden" name="username[]" class="form-control" value="<?= $b['username'] ?>">
	          	<input type="hidden" name="nama_karyawan[]" class="form-control" value="<?= $b['nama_karyawan'] ?>">
	          	<input type="hidden" name="jenis_kelamin[]" class="form-control" value="<?= $b['jenis_kelamin'] ?>">
	          	<input type="hidden" name="nama_jabatan[]" class="form-control" value="<?= $b['nama_jabatan'] ?>">
	            ...
	            <tbody>
	              <tr>
	                ...
	                <td><?= $b['jabatan'] ?></td>
	                <td><input type="number" name="bonus[]" class="form-control" value="0"></td>
	                <td><input type="number" name="thr[]" class="form-control" value="0">
	            </tr>
          	<?php } ?>
        </tbody>
      </table>

      <?php if(empty($input_bonus)) : ?>
