			...
			<div class="card-body">
				...
				<form method="POST" action="<?= base_url('admin/jabatan/tambahAksi') ?>">
					...
					<div class="form-group">
						...
						<input type="number" name="intensif" class="form-control">
						<?= form_error ('intensif', '<div class="text-small text-danger"> </div>') ?>
					</div>

					<div class="form-group">
						<label>Uang Transport</label>
						<input type="number" name="uang_transport" class="form-control">
						<?= form_error ('uang_transport', '<div class="text-small text-danger"> </div>') ?>
					</div>

					<!-- <div class="form-group">
						<label>Total</label>
						<input type="text" name="total" class="form-control" value="<?= $gaji_pokok + $tj_transport + $uang_transport ?>" readonly="readonly">
