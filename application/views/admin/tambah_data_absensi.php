			...
			<?php $no=1; foreach ($input_absensi as $a) { ?>
	            ...
	            <tbody>
	              <tr>
	                ...
	                <td><?= $a['jabatan'] ?></td>
	                <td><input type="number" name="hadir[]" class="form-control input-max" value="0"></td>
	                <td><input type="number" name="libur[]" class="form-control input-max" value="0"></td>
	                <td><input type="number" name="alpha[]" class="form-control input-max" value="0">
	            </tr>
          	<?php } ?>
        </tbody>
      </table>
