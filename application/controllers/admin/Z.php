...
class Bonus extends CI_Controller
{
	...
	public function index()
	{
		...
		// $data['absensi'] = $this->sipModel->get_data('data_bonus')->result();
		...
		/*$data['absensi'] = $this->db->query("SELECT data_bonus.*, data_karyawan.nama_karyawan, data_karyawan.jenis_kelamin, data_karyawan.jabatan
			FROM data_bonus
			INNER JOIN data_karyawan ON data_bonus.username = data_karyawan.username
...
/*	public function edit($id)
	...
	public function editAksi()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->sipModel->update_data('data_bonus', $data, $where);
			$this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
